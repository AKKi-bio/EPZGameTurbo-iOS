...
class SuperTouchPrefs {
    ...
    // Levels: 0: Lowest, 1: Low, 2: Medium, 3: High, 4: Highest
    ...
    static var tapSensitivity: Int {
        get { UserDefaults.standard.object(forKey: keyTapSens) as? Int ?? 4 } // Default Highest (4)
        set { UserDefaults.standard.set(min(max(newValue, 0), 4), forKey: keyTapSens) }
    }
    
    static var swipeResponsiveness: Int {
        get { UserDefaults.standard.object(forKey: keySwipeResp) as? Int ?? 3 } // Default High (3)
        set { UserDefaults.standard.set(min(max(newValue, 0), 4), forKey: keySwipeResp) }
    }
    
    static var microControlAccuracy: Int {
        get { UserDefaults.standard.object(forKey: keyMicroAcc) as? Int ?? 4 } // Default Highest (4)
